...
const CollapseButton = ({className, height='50px', stroke="#b9b9b9", isCollapsed, onClick}: CollapseButtonProps) => {
    return (
        <div className={classNames('collapse-button', className)} onClick={onClick}>
            {!isCollapsed ? (
                <svg xmlns="http://www.w3.org/2000/svg" height={height} viewBox="0 0 55.892 55.892">
                    <path
