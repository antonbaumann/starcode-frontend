...
const GroupsSection = () => {
    const [selectedGroup, setSelectedGroup] = useState<VolunteerGroup>(volunteerGroups[0])
            ...
            <div className='groups-card'>
                <div className='groups-selector'>
                    {volunteerGroups.map((group: VolunteerGroup) => (
                        <div 
                            className={classNames('group-selector-item', {active: group.title === selectedGroup.title})} 
                            key={group.title}
